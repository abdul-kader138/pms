...
.auth-container {
  ...
  .auth-container .auth-header {
    text-align: center;
    border-bottom: 1px solid #4bcf99; }
...
#nprogress .bar {
  ...
  #nprogress .bar .peg {
    box-shadow: 0 0 10px #4bcf99, 0 0 5px #4bcf99; }

#nprogress .spinner {
  top: 25px !important;
  right: 23px !important; }
  #nprogress .spinner .spinner-icon {
    border-top-color: #4bcf99 !important;
    border-left-color: #4bcf99 !important; }
...
#modal-media .images-container {
  ...
  #modal-media .images-container .image-container {
    ...
    #modal-media .images-container .image-container:hover {
      border-color: rgba(75, 207, 153, 0.5); }
